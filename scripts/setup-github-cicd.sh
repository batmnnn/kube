...
GKE_CLUSTER="${GKE_CLUSTER_NAME:-kubelab-v2}"
GKE_LOCATION="${GKE_LOCATION:-${GKE_ZONE:-us-central1-a}}"
...
echo "  GKE_LOCATION           = ${GKE_LOCATION}   (zone for zonal clusters, region for regional)"
